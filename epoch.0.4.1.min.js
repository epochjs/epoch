...
width:this.width,height:this.height})}e(c,a);return c}(Epoch.Chart.Base);Epoch.Chart.Canvas=function(a){function c(a){this.options=null!=a?a:{};c.__super__.constructor.call(this,this.options);this.canvas=$("<canvas></canvas>");this.pixelRatio=null!=this.options.pixelRatio?this.options.pixelRatio:null!=window.devicePixelRatio?window.devicePixelRatio:1;this.canvas.css({width:""+this.width+"px",height:""+this.height+"px"});this.canvas.attr("width",this.width*this.pixelRatio).attr("height",this.height*
this.pixelRatio);null!=this.el&&this.el.append(this.canvas);this.ctx=this.canvas.get(0).getContext("2d")}e(c,a);c.prototype.getWidth=function(){return this.width*this.pixelRatio};c.prototype.getHeight=function(){return this.height*this.pixelRatio};c.prototype.clear=function(){return this.ctx.clearRect(0,0,this.getWidth(),this.getHeight())};c.prototype.getStyles=function(c){return n.getStyles(c,this.el)};return c}(Epoch.Chart.Base);n=function(){function a(){}a.cache={};a.styleList=["fill","stroke",
"stroke-width"];a.container=null;a.purge=function(){return a.cache={}};a.load=function(){$("body").append('<div id="_canvas_css_reference"></div>');return a.container=$("#_canvas_css_reference","body")};a.containerId=function(c){var a,h;a=c.attr("id");null!=(h=c.attr("class"))&&(h=h.split(/\s+/).join("."));return null!=a&&null!=h?"#"+a+"."+h:null!=a?"#"+a:null!=h?"."+h:""};a.getStyles=function(c,k){var h,d,e,p,f,m,q,t;d=""+a.containerId(k)+"__"+c;h=a.cache[d];if(null!=h)return h;h=$(k).clone().html("<svg></svg>");
h.removeAttr("style");a.container.append(h);q=$("svg",h);p=c.split(/\s+/);for(f=m=put(p.shift());p.length;)e=put(p.shift()),f.appendChild(e),f=e;q.html(m);p=$(c,q);f={};t=a.styleList;m=0;for(q=t.length;m<q;m++)e=t[m],f[e]=p.css(e);a.cache[d]=f;$(h,a.container).remove();return f};return a}();$(n.load);Epoch.QueryCSS=n}).call(this);
...
f.values.length,this.inTransition()];d=v[0];e=v[1];for(v=v[2];-2<=--d&&0<=--e;)c=f.values[e],c=[(d+1)*p+a,u(c.y+c.y0)],v&&(c[0]+=p),d===this.options.windowSize-1?this.ctx.moveTo.apply(this.ctx,c):this.ctx.lineTo.apply(this.ctx,c);t.push(this.ctx.stroke())}return t};e.prototype.draw=function(a){null==a&&(a=0);this.clear();this._drawAreas(a);return this._drawStrokes(a)};return e}(Epoch.Time.Stack)}).call(this);
...
null==a.stroke||"none"===a.stroke?"transparent":a.stroke;if(null!=a["stroke-width"])return this.ctx.lineWidth=a["stroke-width"].replace("px","")};e.prototype.draw=function(a){var c,d,e,f,v,p,u,m,q,t,s,n,l,z,x,y,C;null==a&&(a=0);this.clear();l=[this.y(),this.w()];n=l[0];s=l[1];x=this.data;C=[];l=0;for(z=x.length;l<z;l++)q=x[l],0<q.values.length&&(this.setStyles(q.className),y=[this.options.windowSize,q.values.length,this.inTransition()],p=y[0],m=y[1],u=(t=y[2])?-1:0,C.push(function(){var l,x;for(x=
[];--p>=u&&0<=--m;)d=q.values[m],l=[p*s+a,d.y,d.y0],e=l[0],f=l[1],v=l[2],t&&(e+=s),c=[e+1,n(f+v),s-2,this.innerHeight()-n(f)+0.5*this.pixelRatio],this.ctx.fillRect.apply(this.ctx,c),x.push(this.ctx.strokeRect.apply(this.ctx,c));return x}.call(this)));return C};return e}(Epoch.Time.Stack)}).call(this);
...
0,0)};d.prototype._avgLab=function(a,d){var e,f,l,p,n,m,q,t;q=[0,0,0,0];n=q[0];e=q[1];f=q[2];q=q[3];m=0;for(t=a.length;m<t;m++)l=a[m],null!=l.buckets[d]&&(q+=l.buckets[d]);for(p in a)l=a[p],m=null!=l.buckets[d]?l.buckets[d]|0:0,m/=q,l=d3.lab(l.color),n+=m*l.l,e+=m*l.a,f+=m*l.b;return d3.lab(n,e,f).toString()};d.prototype.draw=function(a){null==a&&(a=0);this.clear();return this.ctx.drawImage(this.paint,a,0)};return d}(Epoch.Time.Plot)}).call(this);
